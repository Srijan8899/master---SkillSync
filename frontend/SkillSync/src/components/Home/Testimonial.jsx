    ...
    <div className="px-8 py-8 mx-auto max-w-screen-lg">
      ...
      <div className="flex flex-col gap-8 justify-center items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xxl:grid-cols-4 gap-8">
          {/* testimonial cards */}
          {Reviews.map((Review) => (
            <div key={Review.id} className="flex flex-col justify-center items-center border border-gray-300 rounded-lg shadow-md p-6 gap-4  ease-in-out duration-300 hover:shadow-lg hover:border-blue-500 hover:scale-105">
              {/* testimonial text */}
